...
namespace Prizrak
{
    ...
    {      
        ...
        public void mass_activation_set_device_activation_state(in string udid, int activation_option)
        {
            ...
            switch (activation_option)
            {
                case 1:
                    using (Process process = new Process())
                    {
                        ...
                        ActiviationMethodIsSuccess = (r_code == (int)BinaryReturnCodes.DeviceActivation.Success) ? true : false;
                    }
                    break;
